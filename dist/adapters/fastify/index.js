...
function createFastifyPlugin(opts) {
  ...
  return async (req, reply) => {
    ...
    const bodyBytes = req.body instanceof Uint8Array ? req.body : typeof req.body === "string" ? new TextEncoder().encode(req.body) : new Uint8Array();
