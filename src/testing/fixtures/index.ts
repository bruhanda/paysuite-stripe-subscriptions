 ...
 */
export async function loadFixture<N extends FixtureName>(_name: N): Promise<FixtureOf<N>> {
  throw new Error(
    'loadFixture: bundled fixture payloads ship in a later release. ' +
      'Capture your own with `stripe listen --print-json` and import the JSON directly until then.',
  );
}
