 ...
 *   - PaySuiteError handling via the documented `err.code` programmatic check
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    // The library documents `err.code` as the stable programmatic check —
    // it survives module-graph re-bundling, subpath imports, and bundler
    // duplication where `instanceof` would not.
